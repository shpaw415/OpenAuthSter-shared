...
function isObject(input3) {
	if (
		!isObjectLike(input3) ||
		Object.prototype.toString.call(input3) !== "[object Object]"
	) {
		return false;
	}
...
function validateCrit(
	...
	if (
		...
		protectedHeader.crit.some(
			(input3) => typeof input3 !== "string" || input3.length === 0,
		)
	) {
		throw new Err(
...
export { DEFAULT_COPY, QRProvider, QrUI };
